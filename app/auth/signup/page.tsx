    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4">
        <div className="text-center max-w-md">
          ...
          <h2 className="text-2xl font-display font-bold text-midnight-800 mb-2">Check your email</h2>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <h2 className="text-2xl font-display font-bold text-midnight-800 mb-2">Create your account</h2>
        <p className="text-gray-500 mb-8">Start managing brand deals like a pro. Free forever for up to 3 deals.</p>
        ...
        <div className="relative mb-6">
          ...
          <div className="relative flex justify-center text-sm"><span className="px-4 bg-surface-50 text-gray-400">or sign up with email</span></div>
        </div>
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          ...
          <button type="submit" disabled={loading}
            className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-brand-500 text-white rounded-xl hover:bg-brand-600 transition-colors font-semibold disabled:opacity-50">
